...
<br>
<?php if ($projectId) {
    $result = doQuery("SELECT project_name, village_name, country_name, picture_filename, peopleStats.stat_value AS peopleCount, hhStats.stat_value AS householdCount
