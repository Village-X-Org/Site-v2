		...
		<div class="row">
		  <div class="col s6 m6 l2 right-align hide-on-med-and-down" style="padding: 9% 0% 0% 3%;">
			<div style="width:200px; height:200px; border-radius:20%; border-style:solid; background:#008080CC;">
        				<h1 class="header center-align light" style="padding:9% 0 0 0;font-size:96px;"><b>B</b></h1>
			</div>
		</div> 
	
		<div class="col s6 m6 l6 left-align hide-on-med-and-down" style="padding: 5% 1% 1% 2%;">
			<div style="padding: 5% 5% 5% 5%">
				<h3 class="header col s12 white-text text-lighten-2">Bryan's 35th Birthday</h3>
			</div>
			...
			<div style="padding: 5% 5% 5% 5%">
				<h3 class="header col s12 white-text text-lighten-2 text-shadow: 2px 2px 7px #111111">Bryan's 35th Birthday</h3>
			</div>
			...
			<div style="padding: 5% 20% 5% 20%;">
				<h6 class="header light text-shadow: 2px 2px 7px #111111" style="font-weight:thin">fundraising to <span style="font-size: large; font-weight: bold">Provide Clean Water</span></h6>
      ...
      <div class="card z-depth-1" style="padding: 1% 1% 1% 1%; background:#008080CC;">
        ...
        <div class="card-content">
	        <h5 class="header white-text text-lighten-2">fundraising to</h5>
	          <p style='font-size:28px;'><b>Provide Clean Water</b><br/><span style='margin-top:10px;text-size:24px;'> in Saiti Village, Malawi</span></p>
	          <p style="margin-top:10px;margin-bottom:20px;">Helping 1420 people across 178 households. Saiti has contributed $310, materials, and labor.</p>
...
<br>
		...
		<img src="images/woman_with_goat" class="responsive-img" style='border: black 2px solid; box-shadow: 10px 10px 5px #888888; border-radius:10px;'>	
