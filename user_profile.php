...
<br>
		...
		<div class="left-align">
 		...
 		<div class="flow-text more" style="padding: 5% 0% 0% 0%">
		...
		<!-- <div class="col s12 m12 l6 left-align hide" style="vertical-align: middle;padding: 2% 3% 2% 2%">
		<div>			
					<h6>
							<span style="font-size: xx-large; font-weight: 500">Make your first donation today!</span>
						</h6>
						<div class='progress'>
							<div class='determinate' style='width: 50%'></div>
						</div>
						<div class="valign-wrapper"><i class="material-icons small" style="padding:0 2% 0 0%">face</i>join 700 other people who have donated</div>
<br>
		...
		<div class="left-align">
		 ...
		 <div class="flow-text more" style="padding: 3% 0% 0% 0%">Bryan has supported two projects, helping 200 people and 35 households in rural Malawi.  Bryan has donated to water and livestock projects.  Bryan has led 0 fundraisers.  Bryan is currently not a monthly donor.
		...
		<div style="padding:3% 2% 2% 2%;">
				...
				<h5 class="center-align"><b><span class="blue-text">Bryan's Villages</span> v. <span style="color:rgba(220,220,220,1)">Control Villages</span></b></h5>
	...
	<div class="center-align" style="padding: 2% 0 0 0; font-weight:thin; font-size:medium">dev scores based on 17 indicators collected from each village for health, education, business, lifestyle, agriculture, and livestock</div>
		...
		<div class="col s12 m12 l6 left-align" style="vertical-align: middle;padding: 0% 2% 2% 3%">
            ...
            <div style="padding 0 0 0 0%;margin: 0 0% 0 3%; opacity: 0.6; display:inline-block;background-color: teal;border-radius:50%; border-color:black;border-width:thin; height:100px; width:100px;">
                 				<a class="tooltip" style='text-decoration:none;'><span class="tooltiptext">Thanks, Jeff D!</span><span style="height:100px; width:100px; padding: 0 0% 0 0%; font-size: xx-large; font-color: #ffffff; 
 			...
 			<div class="col s8" >
 			<div style="padding:0 0 0% 0%;vertical-align:middle; display: inline-block;"><span style="font-size: large; font-weight: 300"><b>Bryan donated $15</b></span><span style="font-size: medium; font-weight: 300; text-color:#efebe9"> on Dec 15, 2017 to</span>
 			
 			<span style="font-size: x-large; font-weight: 200"><a href="">Provide Clean Water</a> in Saiti Village</span>
 			</div>
 			</div>
...
<div class="center-align flow-text">see code below for sample of carousel of pics from user's projects</div>

<!-- add carousel of select pics from user's projects-->
