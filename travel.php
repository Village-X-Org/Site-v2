...
<div class="container">
	...
	leading employment sectors, tourism provides important livelihood opportunities, helping to alleviate poverty and drive inclusive development." -- United Nations Secretary-General, Banki-moon</blockquote>
	<br>
...
<div class="container">
	...
	<blockquote class="flow-text">"Picture this: mere hours after touching down in Malawi’s second-largest city, Blantyre, you check into superluxe digs (or pitch your tent) at the Majete Wildlife Reserve, 
		...
		otherworldly moonscape." -- Lonely Planet </blockquote>
		<br>
  ...
  <br>
	...
	<div class="video-container" style="border-style:solid">
        		<iframe width="560" height="315" src="https://www.youtube.com/embed/Ycbl5TOK5x8" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
      	</div>
	</div>
	...
	<div class="col s12 m4 l4" style="padding:0 0 3% 0">
	<div class="video-container" style="border-style:solid">
        		<iframe width="560" height="315" src="https://www.youtube.com/embed/tfs06IjbN60" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
      	</div>
	</div>
	
	<div class="col s12 m4 l4" style="padding:0 0 3% 0">
	<div class="video-container" style="border-style:solid">
        		<iframe width="560" height="315" src="https://www.youtube.com/embed/ibMeGyIHZIY" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
      	</div>
	</div>
	</div>
	
	<div>
	<img class="responsive-img" style="width:100%" src="images/ss_car.jpg">
	</div>
<br>
...
<div id="index-banner" class="parallax-container"
	...
	<div class="section no-pad-bot valign-wrapper"
		...
		<div class="row center" style="width:100%;">
			...
			<div style="padding: 0% 5% 5% 5%;">
				<h2
					class="header col s12 white-text text-lighten-2 text-shadow: 2px 2px 7px #111111">life is calling</h2>
			</div>
...
<div class="valign-wrapper center">
          <div class="card white center scrollspy" id=get_started style="opacity:1; border-radius:20px;border-color:black; border-width:3px">
            <div class="card-content black-text">
              <span class="card-title" style="padding: 3% 5% 0% 5%;"><b>Interested in travel advice that fights extreme poverty? We're here to help with flights, lodging, ground transport, 
              village stays, meals, and much more. Reach us by submitting the form below. Enjoy free inquires and prompt responses.</b></span>
      		<br>
    		<div class="container center-align" id="jqueryvalidation" style="width:100%; padding: 0% 5% 0% 5%;margin:0;">
         		<form id="travel_details" method="post" action="">
             	<input type='hidden' name='id' value=''/>
             		
             		<h5><b>Contact Info</b></h3>
             		
             		<div class="row" style="padding:0;margin:0;">
             		
                             <div class="input-field col s6" style="padding:0;margin:0;">  
                               <input id="travelFirstName" name="travelFirstName" style="border-style:none;font-size:20px;" placeholder="first name" type="text" required data-error=".errorTxt1" />
                        	     <div class="errorTxt1" style="font-size:10px; color:red;"></div>
                             </div>
                             <div class="input-field col s6" style="padding:0;margin:0;">
                               <input id="travelLastName" name="travelLastName" style="border-style:none;font-size:20px;" placeholder="last name" type="text" required data-error=".errorTxt2" />
             		...
             		<div class="row" style="padding:0;margin:0;">							
         				<div class="input-field col s12" style="padding:0;margin:0;" >
         					<input id="travelEmail" name="travelEmail" style="border-style:none; font-size:20px;" placeholder="email address" type="email" required data-error=".errorTxt3">
         					 <div class="errorTxt3" style="font-size:10px; color:red;"></div>
         				</div>
          		</div>
          		
          		<h5><b>Trip Details</b></h3>
          		
          	<div class="row" style="padding:0;margin:0; font-size:20px;">
          		<div class="input-field col s6" style="padding:0 5% 0 0;margin:0;">
                        <select>
                 ...
                 $(document).ready(function() {
          		...
          		<div class="row" style="padding:0;margin:0;">
          		<div class="input-field col s6" style="padding:0 5% 0 0;margin:0;">
          		<input type="text" style="font-size:20px;" class="datepicker" placeholder="arrival date">
          		</div>
          		<div class="input-field col s6" style="padding:0 0 0 0;margin:0;">
          	...
          	<h5><b>Tell Us More</b></h3>
          		
         		<div class="row" style="padding:0;margin:0;"">
         				<div class="input-field col s12" style="border-radius: 5px;padding:0;margin-bottom:5px;">
                   				<textarea style="border-style:none;font-size:20px; height:80px; width:100%" id="travelMessage" placeholder="message (optional)" name="travelMessage"></textarea>
                	 		</div>
         		</div>
